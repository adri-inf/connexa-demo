  ...
  return (
    <>
      <button
        ...
        type='button'
        className={`${openSidebar ? 'hidden' : ''} z-50 fixed bottom-4 right-4 hover:bg-gray-300 dark:hover:bg-gray-500 rounded-full bg-gray-100 dark:bg-gray-700 shadow-md text-primary-complementary dark:text-primary-dark-complementary`}
      >
