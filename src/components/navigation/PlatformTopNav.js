...
export default function PlatformTopNav () {
  ...
  const { openSidebar, setOpenSidebar } = useCommonPlatform()
        ...
        <div className='px-3 py-3 lg:px-5 lg:pl-3'>
          <div className='flex items-center justify-between'>
            <div className='flex items-center justify-start rtl:justify-end'>
              <button onClick={() => { setOpenSidebar(!openSidebar) }} type='button' className='relative inline-flex items-center p-2 text-sm text-gray-500 rounded-lg lg:hidden hover:bg-gray-100 focus:outline-none focus:ring-2 focus:ring-gray-200 dark:text-gray-400 dark:hover:bg-gray-700 dark:focus:ring-gray-600'>
              ...
              <div className='flex items-center ms-3'>
                ...
                <div className='z-50 hidden my-4 text-base list-none bg-white divide-y divide-gray-100 rounded shadow dark:bg-gray-700 dark:divide-gray-600' id='dropdown-user'>
                  ...
                  <ul className='py-1' role='none'>
                    <li>
                      <button onClick={() => { logoutClick(router); setOpenSidebar(false) }} className='w-full text-left block px-4 py-2 text-sm text-gray-700 hover:bg-gray-100 dark:text-gray-300 dark:hover:bg-gray-600 dark:hover:text-white' role='menuitem'>
                        Cerrar sesión
                      </button>
                    </li>
                  </ul>
