...
export default function ModalProfilePicture ({ setShowProfilePictureModal, actualImgSrc }) {
  ...
  return (
    ...
    >
      ...
      >
        <div
          className='overflow-y-auto max-h-[85dvh] dark:border border-gray-700 m-2 lg:m-4 p-4 lg:p-8 flex flex-col shadow bg-white rounded-lg dark:bg-gray-800 text-black dark:text-white relative'
        >
          {/* Botón para cerrar */}
